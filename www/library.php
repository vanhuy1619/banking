...
define("SMTP_UNAME", "khoanguyen30lb@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "henrynguyen"); //Password for SMTP authentication
